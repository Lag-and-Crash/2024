...
if (isset($_GET['file'])) {
    $given = urldecode($_GET['file']);
    if (!(str_ends_with($given, 'resource=php://temp') or str_ends_with($given, 'resource=php://memory'))) {
      echo "Nah mate, you're not allowed to read my *existing* files!";
      return;    
    };
